...
class OrderStatsSerializer(serializers.Serializer):
    ...
    kuryerga_berildi_orders = serializers.IntegerField(read_only=True, help_text="Kuryerga berilgan buyurtmalar")
    yolda_orders = serializers.IntegerField(read_only=True, help_text="Yo'lda bo'lgan buyurtmalar")
    yetkazildi_orders = serializers.IntegerField(read_only=True, help_text="Yetkazilgan buyurtmalar")
