...
# PythonAnywhere uchun production settings
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-%cm#r9=796&ze7jzuxpw-@b8xi&$fsh+0n2y-+nq2%hk&k2ax2')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [
    'yourusername.pythonanywhere.com',  # O'zingizning domain
    '127.0.0.1',
    'localhost',
]
